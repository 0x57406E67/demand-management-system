...
<body>
欢迎<font color="red">${login_user.login_name }</font>登录
<!--main 开始-->
<div class="main">
	<div class="m_left left">
		<div class="box1">
			...
			<div class="box1_cont kjfs line30">
				<ul>
					<li><a href="<%=basePath %>order/listOrder.action"><img src="<%=basePath %>images/icon_1.gif" /><br />我的待办</a></li>
					<li><a href=""><img src="<%=basePath %>images/icon_2.gif" /><br />我的已办</a></li>
					<li><a href="<%=basePath %>order/my_Order.action?uersname=${login_user.id }"><img src="<%=basePath %>images/icon_3.gif" /><br />我的需求</a></li>
					<li><a href="<%=basePath %>order/to_add_order.action"><img src="<%=basePath %>images/icon_4.gif" /><br />新建需求</a></li>
				</ul>
				<div class="clear"></div>
			</div>
		</div>
			...
			<div class="box1_cont h290 xmgl" style="border-top:0px;">
				<div id="tabnav_Content0" class="p10">
					...
					<ul>
						...
						<span class="time">[2014/02/18]</span>
						<span class="name">贺延</span> 
						<span class="bm">商务部</span>    
						</li>
						<li>
						<a href="#">合同范本正文编辑优化  </a> 
						<span class="time">[2014/02/18]</span>
				...
				<div id="tabnav_Content1" class="dis_none p10">
					...
					<span class="right red line30"><a href="">更多&gt;&gt;</a> </span>
				</div>
	...
	<div class="Hr_1 box1 box1_cont h300 mt10" id="div" style="CURSOR: hand">
      <div class="Hr_11 h300">
	  	<div>
	    <a class="act" id="a0" onmouseover="Mea(0);" onmouseout="clearAuto()" href=""  target="_self">
		<img src="<%=basePath %>images/tjb_zz.gif" /><br />需求状态分布</a> 
		<a class="nor" id="a1" onmouseover="Mea(1);" onmouseout="clearAuto()" href=""  target="_self">
		<img src="<%=basePath %>images/tjb_zz.gif" /><br />需求预警分布</a> 
		<a class="nor" id="a2" onmouseover="Mea(2);" onmouseout="clearAuto()" href=""  target="_self">
		<img src="<%=basePath %>images/tjb_bz.gif" /><br />应用系统分布</a>
		<a class="nor" id="a3" onmouseover="Mea(3);"  onmouseout="clearAuto()" href="" target="_self">
	...
	<img id="pc_3" style="DISPLAY: none" height="280" src="<%=basePath %>static/orderChart.action" />
